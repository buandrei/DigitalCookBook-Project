...
public class JDBCPromovariDAO implements PromovariDAO {
    ...
    @Override
    public void add(Promovari promotion) {
        Connection conn = newConnection();
        try {
            PreparedStatement ps1 = conn.prepareStatement("insert into promovari (data_adaugare, data_final, idtip_promovare, iduser) values (now(),?,?,1);");
