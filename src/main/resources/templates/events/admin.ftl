...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Edit/Admin Events</h3>
    </div>
...
<form method="post" action="/events/save">
    ...
    Name: <input name="denumire" type="input" value="${events.denumire!''}">
    <br>
    Description: <input name="descriere" type="input"  value="${events.descriere!''}">
    <br>
    ...
    <br>
    Organizer: <input name="organizator" type="input"  value="${events.organizator!''}">
    <br>
    Idpromo: <input name="idpromo" type="input"  value="${events.idpromo!''}">
    <br>
    Iduser: <input name="iduser" type="input"  value="${events.iduser!''}">
    <br>
    Inactive: <input name="inactiv" type="input"  value="${events.inactiv!''}">
    <br>
